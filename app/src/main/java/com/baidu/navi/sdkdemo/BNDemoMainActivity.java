...
public class BNDemoMainActivity extends Activity {
	...
	@Bind(R.id.wgsNaviBtn) Button mWgsNaviBtn;
	@Bind(R.id.gcjNaviBtn) Button mGcjNaviBtn;
	@Bind(R.id.bdmcNaviBtn) Button mBdmcNaviBtn;
	@Bind(R.id.mDb06llNaviBtn) Button mDb06ll;
